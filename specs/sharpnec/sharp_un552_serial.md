---
spec_id: admin/sharp-nec-un552
schema_version: ai4av-public-spec-v1
revision: 1
title: "Sharp/NEC UN552 Control Spec"
...
generated_at: 2026-06-19T07:43:56.548Z
...
<!-- UNRESOLVED: model-name string returned by device at runtime not stated; UN552 used per task input. Appendix "Supplementary Information by Command" (input terminal values, base model types, eco mode values, sub input values, aspect values) is referenced but not present in the refined source — many enum tables are therefore incomplete. -->
...
<!-- UNRESOLVED: flow_control not stated (only "Full duplex" communication mode). -->
<!-- UNRESOLVED: Appendix "Supplementary Information by Command" referenced for input terminal values, base model types, eco mode values, sub input values, aspect values, and selection signal types — not present in refined source; several enum params are therefore only partially documented. -->
<!-- UNRESOLVED: firmware version compatibility not stated in source. -->
<!-- UNRESOLVED: protocol version number not stated in source. -->
<!-- UNRESOLVED: ID2 model code value for UN552 not stated in source. -->
<!-- UNRESOLVED: no power-on sequence / warm-up delay timing stated (only that no other command is accepted during power-on transition). -->
```
