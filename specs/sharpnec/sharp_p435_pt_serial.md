---
spec_id: admin/sharp-nec-p435-pt
schema_version: ai4av-public-spec-v1
revision: 1
title: "Sharp/NEC P435 Pt Control Spec"
manufacturer: Sharp/NEC
model_family: "P435 Pt"
aliases: []
compatible_with:
  manufacturers:
    - Sharp/NEC
...
retrieved_at: 2026-06-16T17:34:16.734Z
last_checked_at: 2026-09-20T22:18:36.001Z
generated_at: 2026-09-20T22:18:36.001Z
...
known_gaps:
  ...
  - "source is the generic projector command manual; it does not itself confirm which of the 53 commands the P435 Pt model implements."
  ...
  - "which of the 53 commands the P435 Pt model supports is not stated; command support varies by model per source error code 00h/01h."
  - "no unsolicited event / push mechanism documented."
verification:
  verdict: verified
  checked_at: 2026-09-20T22:18:36.001Z
  matched_actions: 53
  action_count: 53
  confidence: medium
  summary: "All 53 spec actions and transport values appear verbatim in the source command catalogue and serial settings. (11 unresolved item(s) noted in Known Gaps.)"
derived_from:
  - vendor_manual
license: ODbL-1.0
...
# Sharp/NEC P435 Pt Control Spec

## Summary
Sharp/NEC P435 Pt projector controlled via an external PC over an RS-232C serial
port (PC CONTROL D-SUB 9P) or a wired/wireless LAN (TCP). This spec covers the
binary frame protocol documented in the Projector Control Command Reference Manual
(BDT140013 Revision 7.1): 53 numbered commands covering power, input switching,
mute, picture/volume/aspect/gain adjust, lens and lens-memory control, freeze,
shutter, eco mode, PIP/PbP, edge blending, audio select, and a broad set of
status/error/information queries.
...
<!-- UNRESOLVED: source is the generic projector command manual; it does not itself confirm which of the 53 commands the P435 Pt model implements. -->
...
## Notes
- Manual: "Projector Control Command Reference Manual", BDT140013 Revision 7.1. Generic Sharp/NEC projector command set applied to the P435 Pt model.
...
- Some models cannot receive commands in standby mode (source, "Connection via a network"); per-model standby-command support is UNRESOLVED here.
...
<!-- UNRESOLVED: which of the 53 commands the P435 Pt model supports is not stated; command support varies by model per source error code 00h/01h. -->
