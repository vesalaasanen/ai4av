---
spec_id: admin/sharp-nec-as271f-bk
schema_version: ai4av-public-spec-v1
revision: 1
title: "Sharp/NEC AS271F BK Control Spec"
manufacturer: Sharp/NEC
model_family: "AS271F BK"
aliases: []
compatible_with:
  manufacturers:
    - Sharp/NEC
...
generated_at: 2026-06-17T19:32:56.686Z
...
# Sharp/NEC AS271F BK Control Spec
...
<!-- UNRESOLVED: The command frame's <ID1> (control ID) and <ID2> (model code) values are device-dependent and not stated in this source. -->
...
<!-- UNRESOLVED: AS271F BK model not explicitly named in the source document; applicability unverified -->
<!-- UNRESOLVED: serial flow control type not stated (Full duplex mode only noted) -->
<!-- UNRESOLVED: concrete enum values for eco mode, aspect, input terminal, and sub-input settings are deferred to the source Appendix "Supplementary Information by Command", which is not present in the refined excerpt -->
<!-- UNRESOLVED: default baud rate, ID1 (control ID) default, and ID2 (model code) value not stated -->
