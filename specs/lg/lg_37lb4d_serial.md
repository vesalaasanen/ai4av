...
source_urls: []
source_documents:
  - title: lg_37lb4d_serial.refined.md
    url: ""
...
**Admin path:**
1. Verify `entity_id: lg_37lb4d` in Convex dashboard
2. Append to `drafts.jsonl`: `{"markdown": "<above>", "sourceArtifactPath": "/Users/vesa/src/ai4av/docs/pdfs/lg_37lb4d_serial.refined.md"}`
3. Run `npx tsx scripts/scraper.ts ingest drafts.jsonl`

**User path:** Call `ingestSpecRevisionAuthenticated` with wrapped object.
