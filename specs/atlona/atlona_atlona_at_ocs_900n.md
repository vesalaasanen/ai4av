...
device_id: atlona/at-ocs-900n
entity_id: atlona_atlona_at_ocs_900n
...
compatible_with:
  ...
  models:
    - AT-OCS-900N
  firmware: ""  # UNRESOLVED: firmware version compatibility range not stated in source
  hardware_revisions: []
  protocol_versions: []
  required_options: []
source_urls:
...
firmware_coverage: ""  # UNRESOLVED: firmware version compatibility range not stated in source
protocol_coverage: []
known_gaps:
  - export_config
  - import_config
