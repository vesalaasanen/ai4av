---
spec_id: admin/audio-technica-atuc-50cu
schema_version: ai4av-public-spec-v1
revision: 1
title: "Audio-Technica ATUC-50CU Control Spec"
...
retrieved_at: 2026-07-12T05:30:28.824Z
last_checked_at: 2026-07-12T08:50:28.200Z
generated_at: 2026-07-12T08:50:28.200Z
firmware_coverage: "2.0.0 or later"
protocol_coverage: []
known_gaps:
  - exprt
...
verification:
  verdict: verified
  checked_at: 2026-07-12T08:50:28.200Z
  matched_actions: 53
  action_count: 53
  confidence: medium
  summary: "All 53 actions, transport values, and every get/notification command match source verbatim; only Export Request (exprt) is unrepresented. (6 unresolved item(s) noted in Known Gaps.)"
derived_from:
  - vendor_manual
license: ODbL-1.0
...
# Audio-Technica ATUC-50CU Control Spec

## Summary
The Audio-Technica ATUC-50CU is a conference unit (CU) for the ATUC-50 digital discussion system. This spec covers its IP control protocol over TCP (port 17300 default) and UDP multicast notifications (225.000.000.100:17000 default). The protocol uses space-delimited ASCII command strings terminated with CR (0x0D), supporting up to 5 simultaneous TCP connections.
