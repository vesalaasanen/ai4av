...
verification:
  ...
  action_count: 66
  confidence: medium
  summary: "All 147 spec actions matched to source command codes; transport parameters verified; no fabricated commands detected. (3 unresolved item(s) noted in Known Gaps.)"
derived_from:
  - vendor_manual
license: ODbL-1.0
