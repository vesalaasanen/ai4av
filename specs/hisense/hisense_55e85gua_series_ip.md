---
spec_id: admin/hisense-55e85gua-series
schema_version: ai4av-public-spec-v1
revision: 1
title: "HiSense 55E85GUA Series Control Spec"
manufacturer: HiSense
model_family: "55E85GUA Series"
aliases: []
compatible_with:
  manufacturers:
    - HiSense
...
retrieved_at: 2026-05-05T02:38:14.912Z
last_checked_at: 2026-06-25T16:56:41.426Z
generated_at: 2026-06-25T16:56:41.426Z
firmware_coverage: "Not stated in source"
protocol_coverage: []
known_gaps:
  - "exact firmware compatibility range not stated in source"
  - "port number not stated in refined source; value inferred from companion Hisense IP Control documentation"
  - "no settable parameter with persist+query semantics documented beyond what is captured in Actions/Feedbacks."
  - "no unsolicited notifications documented in source."
  - "no multi-step sequences documented in source."
  - "source contains no safety warnings, interlock procedures, or power-on sequencing requirements."
  - "TCP port value not stated in the refined source document; inferred from companion HiSense IP Control docs."
  - "connection persistence / keepalive behavior not documented."
  - "firmware version compatibility range not stated."
verification:
  verdict: verified
  checked_at: 2026-06-25T16:56:41.426Z
  matched_actions: 178
  action_count: 178
  confidence: medium
...
# HiSense 55E85GUA Series Control Spec

## Summary
The HiSense 55E85GUA Series is a 55" commercial/hospitality display supporting IP (TCP) control. This spec covers power, input source, picture/audio parameters, channel tuning, captions, OSD language, and hotel-mode lock settings via a four-byte ASCII command protocol (`<mnemonic><digits>` with `OK` acknowledgement).

<!-- UNRESOLVED: exact firmware compatibility range not stated in source -->
...
protocols:
  - tcp
addressing:
  port: 8001  # UNRESOLVED: port number not stated in refined source; value inferred from companion Hisense IP Control documentation
auth:
...
# - queryable       (query variants present for all settings)
# - levelable       (BRIT, CONT, COLR, TINT, SHRP, BKLV, VOLM, MAVL, VLFL ranges)
...
- id: set_brightness_value_brit0000_0100_okay_set_brightness_value
...
- id: set_brightness_to_0_brit0000_okay_set_brightness_value_to_0
...
- id: set_brightness_to_50_brit0050_okay_set_brightness_value_to_50
...
- id: set_brightness_to_100_brit0100_okay_set_brightness_value_to_100
...
- id: set_contrast_value_cont0000_0100_okay_set_contrast_value
...
- id: set_contrast_to_0_cont0000_okay_set_contrast_value_to_0
...
- id: set_contrast_to_50_cont0050_okay_set_contrast_value_to_50
...
- id: set_contrast_to_100_cont0100_okay_set_contrast_value_to_100
...
- id: set_color_saturation_value_colr0000_0100_okay_set_color_saturation_value
...
- id: set_tint_value_tint0000_0100_okay_set_tint_value
...
- id: set_sharpness_value_shrp0000_0020_okay_set_sharpness_value
...
- id: set_sharpness_to_0_shrp0000_okay_set_sharpness_value_to_0
...
- id: set_sharpness_to_10_shrp0010_okay_set_sharpness_value_to_10
...
- id: set_sharpness_to_20_shrp0020_okay_set_sharpness_value_to_20
...
- id: set_backlight_value_bklv0000_0100_okay_set_backlight_value_0000_0100
...
- id: set_volume_adjust_volm0000_0100_okay_set_volume_adjust_0_100
...
- id: set_volume_to_0_volm0000_okay_set_volume_value_to_0
...
- id: set_volume_to_50_volm0050_okay_set_volume_value_to_50
...
- id: set_volume_to_100_volm0100_okay_set_volume_value_to_100
...
- id: volume_range_mavl0000_0100_okay_0_100
...
- id: volume_locked_level_vlfl0000_0100_okay_0_100
...
## Variables
```yaml
# UNRESOLVED: no settable parameter with persist+query semantics documented beyond what is captured in Actions/Feedbacks.
```
...
## Notes
- Command format: four-byte mnemonic + four-digit payload (e.g. `POWR0001`), terminated and acknowledged with `OK`.
- Every setting has a paired query using `????` as the payload (e.g. `VOLM????` returns the current value).
- Hospitality/hotel mode settings (`PBTN`, `MAVL`, `SVOL`, `VLFL`, `RMOT`, `PANL`, `MENU`, `AVMN`, `OSD#`, `INPM`, `POIS`) govern front-panel/remote lockout and power-on defaults — these are commercial-install controls.
- Infrared RC button codes (`BTTN1xxx`) round out the catalogue and can be issued over IP to emulate remote keys.

<!-- UNRESOLVED: TCP port value not stated in the refined source document; inferred from companion HiSense IP Control docs. -->
<!-- UNRESOLVED: connection persistence / keepalive behavior not documented. -->
<!-- UNRESOLVED: firmware version compatibility range not stated. -->
<!-- UNRESRODVED: exact newline/terminator sequence (CRLF vs LF) not shown in refined source. -->
