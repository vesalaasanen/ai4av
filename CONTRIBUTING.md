...
- Suggest a missing device with manufacturer, model/family, official source URL, and use case.
- Report a wrong spec with the spec ID, firmware/protocol version, and the observed mismatch.
- Submit a verified-working report with the command subset, pass/fail result, environment, and optional evidence link.
